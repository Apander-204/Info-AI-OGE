...
const styles = sortCx({
    root: "group relative flex w-full cursor-pointer items-center rounded-md bg-primary outline-focus-ring transition duration-100 ease-linear select-none hover:bg-primary_hover focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-offset-2 min-h-9 py-2",
...
export const NavItemBase = ({ current, type, badge, href, icon: Icon, children, truncate = false, onClick }: NavItemBaseProps) => {
